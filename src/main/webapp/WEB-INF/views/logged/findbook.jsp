    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        ...
        <div class="collapse navbar-collapse" id="mainNavigation">
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="/user/findbook" <c:if test="${newuser}">
                        hidden
...
<section style="width: 99%">
    <div class="row">
        <div class="container p-3 my-3 border shadow p-1 mb-1 bg-white rounded ">
            <h3 style="float:left"> Książki użytkowników </h3>
            <a style="float:right" class="btn btn-outline-info" href="/user/dashboard">Powrót</a>
        </div>
    </div>
    <div class="row">
        <div class="container p-3 my-3 border shadow p-1 mb-1 bg-white rounded ">
        ...
        <!-- Modal -->
        <div class="modal fade" id="propModal" tabindex="-1" aria-labelledby="exampleModalLabel"
             aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">Propozycja wymiany</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Zamknij">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <div class="modal-body">
                        <p> Potwierdź, że książka o tytule:</p>
                        <p id="booktitle"></p>
                        <p> jest dla Ciebie interesująca i chcesz wymienić ją na jedną z twoich książek.</p>
                        <p><small class="form-text text-muted"> Po kliknięciu potwierdź książka znajdzie się w sekcji Twoje propozyjce wymiany skierowne do innych użytkowników w sekcji Moje powiadomienia.</small></p>
                    </div>
